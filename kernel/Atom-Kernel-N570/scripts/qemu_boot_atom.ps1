...
$DefaultImage = Join-Path $RootDir "artifacts\qemu\asus1215p-atom.raw"
...
if (-not (Test-Path $Image -PathType Leaf)) {
    throw "Prepared Atom-patched boot disk image not found: $Image`nPass -Image <path> or create $DefaultImage"
}
